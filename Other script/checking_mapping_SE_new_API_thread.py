...
def open_csv(start,name,end,id):
    ...
    with w as mycsvfile:
	    ...
	    print("thread name:",name, "total id for both:", total,"multiple mapped: ",l,"mapped :",j ,"Not mapped :", k, "rovi id not ingested :", m+q, "gb Id not ingested : ",n+z, "both not ingested: ",p)
