...
def open_csv(start,name,end,id):
	...
	n=0
	    ...
	    print("thread name:",name,"total id for both:", total,"multiple mapped: ",j ,"mapped :",k ,"Not mapped :", l, "rovi id not ingested :", m, "gb Id not ingested : ",n, "both not ingested: ",p)
