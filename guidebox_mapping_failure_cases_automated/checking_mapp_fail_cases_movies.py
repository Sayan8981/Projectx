...
class movies_mapp_fail_cases:
    ...
    def default_param(self):
        ...
        self.projectx_domain_name="https://https://preprod.caavo.com"
    ...
    def main(self,start_id,thread_name,end_id):
        ...
        self.default_param()
        inputFile="input_movies_mappFail/gb_movies_mapp_fail_input_preprod"
    ...
    def thread_pool(self):
        ...
        t3.start()
        t4=Process(target=self.main,args=(300,"thread-4",473))
        t4.start()
        # t5=Process(target=self.main,args=(500,"thread-5",631))
        # t5.start()
