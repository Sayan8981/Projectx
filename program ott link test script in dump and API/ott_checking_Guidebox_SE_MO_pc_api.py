...
def ott(start,name,end,id):
    ...
    with w as mycsvfile,v as mycsvfile1:
        ...
        for aa in range(start,end,1000):
                            ...
                            if data_resp_url1==True:
                             ...
                             if len(data_resp_url)==1:
                                 ...
                                 if data_resp==[]:
                                     ...
                                     format_price_purchasetype_mismatch=''
                                     format_price_purchasetype_mismatch_=[]
                                     format_price_purchasetype_match=''
                                     format_price_purchasetype_match_=[]
                                             ...
                                             for x in data_resp1:
                                                 if x.get("videos"):
                                                     ...
                                                     for mm in x.get("videos"):
                                                         if mm.get("fetched_from")=='GuideBox' and mm.get("constraints") is None and mm.get("constraints")!=[] and mm.get("price_type")!="free":
                                                 ...
                                                 if jj in Gb_ott_url_purchase:
                                                     ...
                                                     for mm in a:
                                                         ...
                                                         for hh in projectx_videos:
                                                             if hh.get("fetched_from")=='GuideBox' and hh.get("link").get("uri").encode()==mm.get("link") and hh.get("constraints") is None and hh.get("constraints")!=[] and hh.get("price_type")!="free":
                                                                 ...
                                                                 if hh.get("source_program_id") is not None: 
                                                                     if hh.get("source_program_id").encode('utf-8')==purchase_source_program_id:
                                                                         ...
                                                                         purchase_source_program_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", purchase_source_program_id,"Expected: ",hh.get("source_program_id").encode('utf-8')])
                                                                 if hh.get("launch_id") is not None:
                                                                     if hh.get("launch_id").encode('utf-8')==purchase_source_program_id:
                                                                         ...
                                                                         purchase_launch_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("launch_id"),"Expected: ",hh.get("launch_id").encode('utf-8')])
                                                                 ...
                                                                 if hh.get("roku_id") is not None:
                                                                     if purchase_source_program_id in hh.get("roku_id").encode('utf-8'):
                                                                         ...
                                                                         purchase_roku_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("roku_id"),"Expected in:",purchase_source_program_id])
                                                                 ...
                                                                 if hh.get("firetv_id") is not None:
                                                                     if purchase_source_program_id in hh.get("firetv_id").encode('utf-8'):
                                                                         ...
                                                                         purchase_firetv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("firetv_id"),"Expected in: ",hh.get("firetv_id")])
                                                                 ...
                                                                 if hh.get("appletv_id") is not None:
                                                                     if purchase_source_program_id in hh.get("appletv_id").encode('utf-8'):
                                                                         ...
                                                                         purchase_appletv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("appletv_id"),"Expected in :",purchase_source_program_id])
                                                                 ...
                                                                 if hh.get("androidtv_id") is not None:
                                                                     if purchase_source_program_id in hh.get("androidtv_id").encode('utf-8'):
                                                                         ...
                                                                         purchase_androidtv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("androidtv_id"),"Expected in :",purchase_source_program_id])

                                                                 price=''
                                                                 purchase_type=''          
                                                                 format_price_purchasetype_=[]
                                                                 if mm.get("formats"):
                                                                    if hh.get("price")=='0.0':
                                                                        price='0.00' 
                                                                    if hh.get("purchase_type")=='buy':
                                                                        purchase_type='purchase'
                                                                                                         
                                                                    if price=='0.00' and purchase_type=='purchase':    
                                                                        format_price_purchasetype_.append({u'price': price, u'pre_order': False, u'type': purchase_type, u'format': hh.get("quality")})
                                                                    elif price=='0.00' and purchase_type!='purchase':
                                                                        format_price_purchasetype_.append({u'price': price, u'pre_order': False, u'type': hh.get("purchase_type"), u'format': hh.get("quality")})
                                                                    elif price!='0.00' and purchase_type=='purchase': 
                                                                        format_price_purchasetype_.append({u'price': hh.get("price"), u'pre_order': False, u'type': purchase_type, u'format': hh.get("quality")})
                                                                    else: 
                                                                        format_price_purchasetype_.append({u'price': hh.get("price"), u'pre_order': False, u'type': hh.get("purchase_type"), u'format': hh.get("quality")})                                                      
                                                                    for cc in format_price_purchasetype_:
                                                                        if cc in mm.get("formats"):
                                                                            format_price_purchasetype_match='True'
                                                                            format_price_purchasetype_match_=['True']
                                                                        else:
                                                                            format_price_purchasetype_mismatch='True'
                                                                            format_price_purchasetype_mismatch_.append([mm.get("link"),"worng :",format_price_purchasetype_])
                                                 else:
                                     ...
                                     if data_resp_gb.get("subscription_web_sources")!=[]:
                                         ...
                                         if a:
                                             for x in a:
                                                 ...
                                                 if "www.cbs.com/shows" in b:
                                                     try:
                                                         subscription_source_program_id=re.findall("\w+\d+\w+", b)[0]
                                                     except IndexError:
                                                         subscription_source_program_id=re.findall("\w+", b)[7] 
                                                         ...
                                                         try: 
                                                             ...
                                                             if hh.get("source_program_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and hh.get("source_program_id").encode()==subscription_source_program_id and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_source_program_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_source_program_id:",hh.get("source_program_id"),"Expected:",subscription_source_program_id]) 
                                                             ...
                                                             if hh.get("launch_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and hh.get("launch_id").encode()==subscription_source_program_id and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_launch_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_launch_id:",hh.get("launch_id"),"Expected:",subscription_source_program_id])
                                                             ...
                                                             if hh.get("roku_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("roku_id") and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_roku_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_roku_id:",hh.get("roku_id"),"Expected:",subscription_source_program_id])
                                                             ...
                                                             if hh.get("firetv_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("firetv_id") and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_firetv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_firetv_id:",hh.get("firetv_id"),"Expected:",subscription_source_program_id])
                                                             ...
                                                             if hh.get("appletv_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("appletv_id") and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_appletv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_appletv_id:",hh.get("appletv_id"),"Expected:",subscription_source_program_id])
                                                             ...
                                                             if hh.get("androidtv_id") is not None:
                                                                 ...
                                                                 if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("androidtv_id") and hh.get("constraints") is not None:
                                                                     ...
                                                                     subscription_androidtv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_androidtv_id:",hh.get("androidtv_id"),"Expected:",subscription_source_program_id])
                                                         except TypeError:
                                                             pass
                                     ...
                                     if data_resp_gb.get("tv_everywhere_web_sources")!=[]:
                                         ...
                                         if a:
                                             for x in a:
                                                 ...
                                                 if "www.cbs.com/shows" in b:
                                                     try: 
                                                         tv_everywhere_source_program_id=re.findall("\w+\d+\w+", b)[0]
                                                     except IndexError:
                                                         tv_everywhere_source_program_id=re.findall("\w+", b)[7] 
                                                     ...
                                                     try:
                                                         if hh.get("fetched_from")=='GuideBox' and "cable_subscription" in hh.get("constraints"):
                                                             ...
                                                             if hh.get("link").get("uri").encode()==b and hh.get("source_program_id").encode()==tv_everywhere_source_program_id:
                                                                 ...
                                                                 tv_everywhere_source_program_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_source_program_id:",hh.get("source_program_id"),"Expected:",tv_everywhere_source_program_id])
                                                             if hh.get("link").get("uri").encode()==b and hh.get("launch_id").encode()==tv_everywhere_source_program_id:
                                                                 ...
                                                                 tv_everywhere_launch_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_launch_id:",hh.get("launch_id"),"Expected:",tv_everywhere_source_program_id])
                                                             if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("roku_id"):
                                                                 ...
                                                                 tv_everywhere_roku_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_roku_id:",hh.get("roku_id"),"Expected:",tv_everywhere_source_program_id])
                                                             if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("firetv_id"):
                                                                 ...
                                                                 tv_everywhere_firetv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_firetv_id:",hh.get("firetv_id"),"Expected:",tv_everywhere_source_program_id])
                                                             if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("appletv_id"):
                                                                 ...
                                                                 tv_everywhere_appletv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_appletv_id:",hh.get("appletv_id"),"Expected:",tv_everywhere_source_program_id])
                                            ...
                                            for mm in a:
        		                                ...
        		                                if 'https://www.mgo.com/' in mm.get("link"):
                                                        ...
                                                        if hh.get("source_program_id").encode('utf-8')==purchase_source_program_id:
                                                            ...
                                                            purchase_source_program_id_mismatch='True'
                                                            purchase_source_program_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("source_program_id"),"Expected:",purchase_source_program_id])
                                                        if hh.get("launch_id") is not None:
                                                            if hh.get("launch_id").encode('utf-8')==purchase_source_program_id:
                                                                purchase_launch_id_match="True" 
                                                                purchase_launch_id_match_=['True']
                                                                ...
                                                                purchase_launch_id_mismatch='True'
                                                                purchase_launch_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("launch_id"),"Expected:",purchase_source_program_id])
                                                        if hh.get("roku_id") is not None:
                                                            if purchase_source_program_id in hh.get("roku_id").encode('utf-8'):
                                                                purchase_roku_id_match="True"
                                                                purchase_roku_id_match_=['True']
                                                        ...
                                                        if hh.get("firetv_id") is not None:
                                                            ...
                                                            if purchase_source_program_id in hh.get("firetv_id").encode('utf-8'):
                                                                ...
                                                                purchase_firetv_id_mismatch='True'
                                                                purchase_firetv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("firetv_id"),"Expected:",purchase_source_program_id])
                                                        if hh.get("appletv_id") is not None: 
                                                            if purchase_source_program_id in hh.get("appletv_id").encode('utf-8'):
                                                                purchase_appletv_id_match="True"
                                                                purchase_appletv_id_match_=['True']
                                                                ...
                                                                purchase_appletv_id_mismatch='True'
                                                                purchase_appletv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("appletv_id"),"Expected:",purchase_source_program_id])
                                                        if hh.get("androidtv_id") is not None:
                                                            if purchase_source_program_id in hh.get("androidtv_id").encode('utf-8'):
                                                                purchase_androidtv_id_match="True"
                                                                purchase_androidtv_id_match_=['True']
                                                                ...
                                                                purchase_androidtv_id_mismatch='True'
                                                                purchase_androidtv_id_mismatch_.append([mm.get("link"),"wrong purchase_source_program_id: ", hh.get("androidtv_id"),"Expected:",purchase_source_program_id])
                                            ...
                                            try:
                                                ...
                                                if hh.get("firetv_id") is not None:
                                                    ...
                                                    if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("firetv_id") and hh.get("constraints") is not None:
                                                        ...
                                                        subscription_firetv_id_mismatch='True'
                                                        subscription_firetv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_firetv_id:",hh.get("firetv_id"),"Expected in:",subscription_source_program_id])
                                                ...
                                                if hh.get("appletv_id") is not None:                                          
                                                    ...
                                                    if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("appletv_id") and hh.get("constraints") is not None:
                                                        ...
                                                        subscription_appletv_id_mismatch='True'
                                                        subscription_appletv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_appletv_id:",hh.get("appletv_id"),"Expected in:",subscription_source_program_id])
                                                if hh.get("androidtv_id") is not None:
                                                    ...
                                                    if ("service_subscription" in hh.get("constraints") or hh.get("constraints")==[]) and subscription_source_program_id in hh.get("androidtv_id") and hh.get("constraints") is not None:
                                                        ...
                                                        subscription_androidtv_id_mismatch='True'
                                                        subscription_androidtv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_androidtv_id:",hh.get("androidtv_id"),"Expected in:",subscription_source_program_id]) 
                                            except TypeError:
                                                pass            
                                            ...
                                            if hh.get("fetched_from")=='GuideBox' and "cable_subscription" in hh.get("constraints"):
                                                ...
                                                if hh.get("launch_id") is not None:
                                                    ...
                                                    if hh.get("link").get("uri").encode()==b and hh.get("launch_id").encode()==tv_everywhere_source_program_id:
                                                        ...
                                                        tv_everywhere_launch_id_mismatch='True'
                                                        tv_everywhere_launch_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_launch_id:",hh.get("launch_id"),"Expected in:",tv_everywhere_source_program_id])
                                                ...
                                                if hh.get("firetv_id") is not None:
                                                    if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("firetv_id"):
                                                        ...
                                                        tv_everywhere_firetv_id_mismatch='True'
                                                        tv_everywhere_firetv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_firetv_id:",hh.get("firetv_id"),"Expected in:",tv_everywhere_source_program_id])
                                                ...
                                                if hh.get("appletv_id") is not None:
                                                    if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("appletv_id"):
                                                        ...
                                                        tv_everywhere_appletv_id_mismatch='True'
                                                        tv_everywhere_appletv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_appletv_id:",hh.get("appletv_id"),"Expected in:",tv_everywhere_source_program_id])
                                                ...
                                                if hh.get("androidtv_id") is not None:
                                                    if hh.get("link").get("uri").encode()==b and tv_everywhere_source_program_id in hh.get("androidtv_id"):
                                                        ...
                                                        tv_everywhere_androidtv_id_mismatch='True'
                                                        tv_everywhere_androidtv_id_mismatch_.append(["Service:", c,hh.get("link").get("uri"),"Wrong_androidtv_id:",hh.get("androidtv_id"),"Expected in:",tv_everywhere_source_program_id])
                                        except TypeError:
                                            pass    
            ...
            except (IndexError,ValueError,TypeError,AttributeError, pymongo.errors.OperationFailure,_mysql_exceptions.OperationalError,httplib.BadStatusLine,urllib2.HTTPError,socket.error,URLError) as e:
