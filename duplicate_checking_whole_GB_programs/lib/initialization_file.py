...
duplicate_domain='http://34.231.212.186:81/projectx/duplicate?sourceId=%d&sourceName=%s&showType=%s'
projectx_mapping_api_domain="http://34.231.212.186:81/projectx/%d/mapping/"
gb_details_api="http://34.231.212.186:81/projectx/guideboxdata?sourceId=%d&showType=%s"
