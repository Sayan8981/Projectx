    ...
    def main(self,start_id,thread_name,end_id):
        ...
        with output_file as mycsvfile:
            ...
            for aa in range(start_id,end_id,1000):
                try:
                    query_vudu=self.sourcetable.aggregate([{"$match":{"$and":[{"show_type":{"$in":["MO","SE","SM"]}},
                        {"language" : "English"}]}},{"$project":{"launch_id":1,"_id":0,"show_type":1,"series_id":1,"title":1
                        ,"release_year":1,"episode_number":1,"season_number":1,"alternate_title":1,"duration":1,"image":1,"url":1
                        ,"description":1,"credit_summary":1,"category":1}},{"$skip":aa},{"$limit":1000}])
