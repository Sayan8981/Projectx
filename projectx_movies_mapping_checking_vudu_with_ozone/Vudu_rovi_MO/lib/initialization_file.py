...
api_duplicate_checking_mo="http://34.231.212.186:81/projectx/duplicate?sourceId=%d&sourceName=%s&showType=MO"

source_mapping_api="http://34.231.212.186:81/projectx/mappingfromsource?sourceIds=%d&sourceName=%s&showType=MO"
