...
def checking_mapping_episodes(source_id,rovi_id,source_sm_id,episode_title,ozoneepisodetitle,OzoneOriginalEpisodeTitle,rovi_series_id,
                                            rovi_projectx_id,source_projectx_id,source_projectx_id_sm,writer,thread_name,source):
    ...
    if len(rovi_projectx_id)==1 and len(source_projectx_id)==1:
        if rovi_projectx_id == source_projectx_id:
            ...
            writer.writerow({"%s_sm_id"%source:source_sm_id,"%s_id"%source:source_id,"Rovi_id":rovi_id,"Rovi_SM_id":rovi_series_id,"episode_title":episode_title,
                            "ozoneepisodetitle":ozoneepisodetitle,"OzoneOriginalEpisodeTitle":OzoneOriginalEpisodeTitle,"projectx_id_rovi":str(rovi_projectx_id[0]),
    ...
    #TODO: condition 2 , to check multiple projectx ids for a source        
        ...
        writer.writerow({"%s_sm_id"%source:source_sm_id,"%s_id"%source:source_id,"Rovi_id":rovi_id,"Rovi_SM_id":rovi_series_id,"episode_title":episode_title,
                          "ozoneepisodetitle":ozoneepisodetitle,"OzoneOriginalEpisodeTitle":OzoneOriginalEpisodeTitle,"projectx_id_rovi":rovi_projectx_id,
    ...
    #TODO: condition 3, to check both source id ingested
        ...
        writer.writerow({"%s_sm_id"%source:source_sm_id,"%s_id"%source:source_id,"Rovi_id":rovi_id,"Rovi_SM_id":rovi_series_id,"episode_title":episode_title,
                         "ozoneepisodetitle":ozoneepisodetitle,"OzoneOriginalEpisodeTitle":OzoneOriginalEpisodeTitle,"projectx_id_rovi":'',"projectx_id_%s"%source:'',
                            "Episode mapping":'Fail',"Comment":'No Ingestion of both sources'})
    #TODO: condition 4, to check rovi_id ingested
    elif len(source_projectx_id)==1 and len(rovi_projectx_id)==0:
        initialization_file.rovi_id_not_ingested_count=initialization_file.rovi_id_not_ingested_count+1
        writer.writerow({"%s_sm_id"%source:source_sm_id,"%s_id"%source:source_id,"Rovi_id":rovi_id,"Rovi_SM_id":rovi_series_id,"episode_title":episode_title,
                          "ozoneepisodetitle":ozoneepisodetitle,"OzoneOriginalEpisodeTitle":OzoneOriginalEpisodeTitle,"projectx_id_rovi":'',
            ...
            if data_resp_url==[]:
                ...
                if source_projectx_id!=[]:
                    if rovi_projectx_id[0] in source_projectx_id:
                        initialization_file.mapped_count=initialization_file.mapped_count+1
                        writer.writerow({"%s_sm_id"%source:source_sm_id,"%s_id"%source:source_id,"Rovi_id":rovi_id,"Rovi_SM_id":rovi_series_id,"episode_title":episode_title,
                                         "ozoneepisodetitle":ozoneepisodetitle,"OzoneOriginalEpisodeTitle":OzoneOriginalEpisodeTitle,"projectx_id_rovi":str(rovi_projectx_id),
