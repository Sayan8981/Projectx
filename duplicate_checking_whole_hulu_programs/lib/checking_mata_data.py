...
class validation:
    ...
    def checking_same_program(self,duplicate_id):
        ...
        try:
            projectx_api_preprod=initialization_file.projectx_preprod_domain%'{}'.format(",".join([str(i) for i in duplicate_id]))
            ...
            print ("exception caught ..........................................................",e.reason,type(e),[self.px_id1,self.px_id2])
            print ("\n")
            print ("Retrying.............")
            print ("\n")    
