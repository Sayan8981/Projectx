...
class rovi_ids:
    ...
    def main(self,start_id,thread_name,end_id):
        ...
        fieldnames = ["rovi_sm_id","rovi_id","rovi_show_type","record_language"]
            ...
            for aa in range(start_id,end_id,10):
                try:
                    ...
                    for data in rovi_query:
                        ...
                        self.rovi_show_type=data.get("show type").encode('utf-8')
                        self.record_language=data.get("record language")
                        ...
                        #self.getting_source_ids(data,thread_name)
                            ...
                            self.writer.writerow([self.rovi_sm_id,self.rovi_id,self.rovi_show_type,self.record_language])
    ...
    def thread_pool(self):   
        ...
        t17.start()
        t18=Process(target=self.main,args=(850000,"thread-18",990635))
        t18.start()
